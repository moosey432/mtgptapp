...
p('Nirvana Grunge',{guitar:'fender-stratocaster',amp:'marshall-dsl',cab:'marshall-4x12-v30',pedals:[{name:'Boss DS-1 Distortion',settings:{gain:0.7}}]}),
...
p('Pink Floyd Ambient Lead',{guitar:'fender-stratocaster',amp:'line6-helix-amp-model',cab:'vox-2x12',pedals:[{name:'Boss DD-7 Delay',settings:{time:0.65,feedback:0.55,mix:0.4}},{name:'Strymon BigSky',settings:{mix:0.45}}]}),
